  ...
  return (
    <header className="h-14 bg-[#0d0d1f]/80 border-b border-white/5 backdrop-blur-sm flex items-center px-6 gap-4 shrink-0">
      <div className="ml-auto flex items-center gap-3">
        <Link href="/student/notifications" className="relative w-8 h-8 rounded-lg bg-white/5 hover:bg-white/10 flex items-center justify-center text-slate-400 hover:text-white transition-all">
