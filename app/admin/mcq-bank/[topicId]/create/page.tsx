  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-white">Create New MCQ</h1>
          <p className="text-slate-400 text-sm mt-1">Add a new standalone question to the bank</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="glass-card p-6 space-y-6">
        ...
        <div className="pt-4 border-t border-white/10 flex justify-end gap-3">
          ...
          >
            {isPending ? "Saving..." : <><Save className="w-4 h-4" /> Save Question</>}
          </button>
        </div>
      </form>
    </div>
